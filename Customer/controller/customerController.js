...
exports.editCustomer = async (req, res) => {
    ...
    try {
        ...
        const customer = await Customer.findOne({ _id: customerId, organizationId: organizationId });
        if (!customer) {
            return res.status(404).json({
...
exports.deleteCustomer = async (req, res) => {
    ...
    try {
        ...
        // Delete the customer
        await Customer.deleteOne({ _id: customerId, organizationId: organizationId });
